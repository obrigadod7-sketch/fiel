...
import { Plus, MapPin, User, Clock, MessageCircle, Image as ImageIcon, MessageSquare, Send, X, Filter, Info, ExternalLink, Lock, Utensils, Scale, Heart, Home as HomeIcon, Briefcase, GraduationCap, Users, Shirt, Armchair, Car, Wrench, Sparkles, Baby, Flower2, Monitor, Package } from 'lucide-react';
      ...
      <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-6 max-w-7xl overflow-x-hidden">
        <div className="flex gap-4">
          ...
          <div className="hidden lg:block w-80 flex-shrink-0 space-y-4 max-h-[calc(100vh-200px)] overflow-y-auto scroll-container pr-2">
            ...
            {/* Mural de Mensagens - Versão Simplificada */}
            <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-200">
              ...
              <div className="p-2 max-h-32 overflow-y-auto">
                {muralMessages.length === 0 ? (
                  <p className="text-xs text-gray-400 text-center py-2">Seja o primeiro a deixar uma mensagem!</p>
                ) : (
                  <div className="space-y-1.5">
                    {muralMessages.slice(0, 4).map((msg, idx) => (
                      <div key={msg.id || idx} className="text-xs">
                        <p className="text-gray-600 line-clamp-1">&ldquo;{msg.message}&rdquo;</p>
